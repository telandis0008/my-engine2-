...
function music_class:New(parent)
	...
	self.music.Parent = workspace.Level.MusicFolder
	workspace.Level.MusicFolder.Boosting:Clone().Parent = workspace.Level.MusicFolder.Music
	workspace.Level.MusicFolder.Underwater:Clone().Parent = workspace.Level.MusicFolder.Music
